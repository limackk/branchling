...
`scripts/product.mjs` was created in [TL-33](TL-33-packaging-global-install-and-npx.md)
...
step 2 of [TL-81](TL-81-distribution-channels-and-the-worktrail-name-collision-in.md),
...
(`worktrail`, [TL-20](TL-20-close-the-tool-s-name-before-open-source-publication.md)). It
