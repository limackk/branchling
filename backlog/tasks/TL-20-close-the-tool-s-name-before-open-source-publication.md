...
- 2026-08-30 — claude — on the founder's instruction moved from the "Backlog
  ...
  [TL-32](TL-32-english-public-surface-of-the-module.md). Both are
...
- 2026-08-30 — claude — **founder's decision: `tasklog` stays.** Availability
  ...
  [TL-33](TL-33-packaging-global-install-and-npx.md) and the home directory
  in [TL-34](TL-34-home-directory-preferences-and-project-registry.md). **An
...
- 2026-09-01 — agent:claude — **DECISION REVERSED: `tasklog` → `worktrail`.**
  ...
  **This task does NOT go back to `todo`.** It closed the question "is
  ...
  it travels in
  [TL-117](TL-117-product-name-from-a-single-constant-not-from-a-literal.md) together
...
[TL-117](TL-117-product-name-from-a-single-constant-not-from-a-literal.md) has already
