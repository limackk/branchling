...
Found while writing tests for [TL-25](TL-25-closing-the-flag-validation-gap-in-5-worktrail-commands.md)
...
[TL-23](TL-23-worktrail-init-and-stats-creating-a-backlog-and-showing-its.md) leads to — `worktrail init --dir .`
