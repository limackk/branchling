...
- [ ] The `quote` row reads a task the fixture really created. [proof: envelope-green]
- [ ] Positive control: pointing a row at a non-existent id FAILS the suite. [proof: envelope-green]
