...
- [x] Several concurrent claims for one event append exactly one attribution
      entry. [proof: concurrent-claim]
- [x] Every losing process is refused and the original event remains unchanged.
      [proof: concurrent-claim]
- [x] Existing attribution and history behavior remains green.
      [proof: suite-green]
