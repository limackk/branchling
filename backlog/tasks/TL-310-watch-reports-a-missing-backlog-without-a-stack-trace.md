...
- [x] Running `watch` outside a backlog produces no stack trace and names how
  to select or create a backlog. [proof: missing-backlog-message]
- [x] Existing `watch` output and JSON tests remain green. [proof: missing-backlog-message]
