...
The module is designed for publication ([TL-20](TL-20-close-the-tool-s-name-before-open-source-publication.md)
...
1. ~~`README.md` → EN~~ — **DONE in [TL-49](TL-49-the-readme-in-the-tarball-is-another-project-s-document.md)
...
- **Order relative to TL-20:** this task does not depend on the name — the
  ...
  other.
- **The `Backlog — open source publication` epic is new.** [TL-20](TL-20-close-the-tool-s-name-before-open-source-publication.md)
