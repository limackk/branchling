...
7. **Product name from a single constant.** Today the product name (then
   ...
   [TL-34](TL-34-home-directory-preferences-and-project-registry.md) adds
...
- Name **settled as `tasklog`** ([TL-20](TL-20-close-the-tool-s-name-before-open-source-publication.md)
...
- Out of scope: home directory and registry (TL-34), English text
  ([TL-32](TL-32-english-public-surface-of-the-module.md)).
