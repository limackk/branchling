...
related_docs: [backlog/tasks/TL-382-provider-execution-uses-one-thin-user-owned-adapter-path.md, scripts/agent-profiles.mjs, scripts/tests/agent-reference-adapters.test.mjs]
