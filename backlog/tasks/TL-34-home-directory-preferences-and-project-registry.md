...
2. The directory name comes from **one constant** — `worktrail` is a
   provisional name ([TL-20](TL-20-close-the-tool-s-name-before-open-source-publication.md)),
...
- An assumption to be disproven: the registry may never gain a second entry
  (§11 point 1). In that case [TL-36](TL-36-cross-project-view-over-multiple-projects.md)
