...
related_docs: [scripts/agent-profiles.mjs, scripts/tests/agent-profile-setup.test.mjs, examples/agent-adapters/README.md] # paths relative to the repository root
