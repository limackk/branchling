...
- [ ] `doctor --json` is complete and parseable through the UI test command
  boundary within its existing timeout. [proof: doctor-json-ui]
- [ ] Forced-colour rendering remains terminal-independent. [proof: doctor-json-ui]
- [ ] The full suite is green. [proof: full-suite]
