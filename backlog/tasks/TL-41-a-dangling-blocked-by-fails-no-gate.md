...
cp backlog/tasks/TL-41-a-dangling-blocked-by-fails-no-gate.md /tmp/bl1451.bak
sed -i '' 's/^blocked_by: \[\]/blocked_by: [BL-999999]/' backlog/tasks/TL-41-a-dangling-blocked-by-fails-no-gate.md
node scripts/cli.mjs check --refs; echo "exit=$?"
cp /tmp/bl1451.bak backlog/tasks/TL-41-a-dangling-blocked-by-fails-no-gate.md
```
