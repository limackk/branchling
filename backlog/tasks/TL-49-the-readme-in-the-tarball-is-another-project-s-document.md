...
[TL-33](TL-33-packaging-global-install-and-npx.md) the entry point is
`worktrail`. Task numbers are written as `BL-NNN`, even though the prefix is
configuration ([TL-42](TL-42-task-id-prefix-is-configuration-not-code.md)).
...
[TL-32](TL-32-english-public-surface-of-the-module.md), and both rewrite
...
6. Paste CLI output examples in only at the end — after
   [TL-51](TL-51-worktrail-command-help-fails-in-8-of-12-commands.md) and
   [TL-52](TL-52-color-and-consistent-cli-messages-in-a-single-ui-mjs-module.md),
...
- 2026-08-31 done — agent:claude — on the founder's instruction the README was
  ...
  [TL-32](TL-32-english-public-surface-of-the-module.md) and its decision
