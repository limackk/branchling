...
Owner decision 2026-08-31 ([TL-65](TL-65-settle-import-from-an-existing-task-tracker.md)):
...
and tree that
[TL-56](TL-56-the-types-vocabulary-in-config-yaml-has-drifted-from-the.md) is
meant to close.
