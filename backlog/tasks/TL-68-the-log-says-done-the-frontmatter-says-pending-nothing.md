...
verification:
  ...
  - id: recorded
    bash: "grep -q 'step 5 settled' backlog/tasks/TL-68-the-log-says-done-the-frontmatter-says-pending-nothing.md && echo 'the error/warning choice is recorded with its reason — OK'"
  - id: doctor
...
[TL-52](TL-52-color-and-consistent-cli-messages-in-a-single-ui-mjs-module.md) had
