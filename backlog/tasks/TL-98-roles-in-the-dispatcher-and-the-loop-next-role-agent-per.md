...
- `backlog/tasks/TL-87-worktrail-next-atomic-task-assignment-for-an-agent.md`
  and `backlog/tasks/TL-96-worktrail-run-a-next-agent-close-loop-to-an-empty-queue.md`
  — the contracts this task extends.
- `backlog/tasks/TL-97-task-role-field-role-requirement-from-the-configuration.md`
