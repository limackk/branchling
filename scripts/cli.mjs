...
export const COMMANDS = {
  ...
  activity: {
    script: "activity-record.mjs",
    summary: "record one heartbeat — the callable input under every time measurement",
    usage: [
      `${N} activity record [--task <ID>] [--kind tool] [--actor <ns:name>] [--source <s>]`,
      `${N} activity record [--session <s>] [--file <path>] [--branch <b>] [--no-throttle]`,
      "",
      "  One piece of evidence that somebody was working, appended to",
      "  `activity/<ID>.jsonl`. The host's payload may arrive as JSON on STANDARD",
      ...
      "",
      "  exit: 0 recorded or throttled · 1 refused · 2 usage error",
    ].join("\n"),
  },
  focus: {
