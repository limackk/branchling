...
test("ordinary English words not used by the project are accepted", () => {
  assert.deepEqual(
    auditText("Alternating projections produce correctable statements."),
    [],
    "the language guard rejected ordinary English as an unknown project word"
  );
});
